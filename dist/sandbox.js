...
const game = new Game();
import { printGrid } from "./shared/gridutils.js";
...
function moveRandomCharacter(team) {
  ...
  const randX = Math.floor(Math.random() * character.movement * 2) - character.movement;
  const randY = Math.floor(Math.random() * character.movement * 2) - character.movement;
