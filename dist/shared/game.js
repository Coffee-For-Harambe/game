...
export default class Game {
  constructor() {
    ...
    this.teams = [];
    this.teams[0] = new Team([new Character.Rogue(1, 15), new Character.Monk(4, 15), new Character.Ranger(7, 15), new Character.Warrior(10, 15), new Character.Wizard(13, 15)]);
    this.teams[1] = new Team([new Character.Skeleton(0, 0), new Character.Skeleton(3, 13), new Character.Skeleton(7, 0), new Character.Dragon(9, 0), new Character.Skeleton(13, 0), new Character.Skeleton(15, 0)]);
