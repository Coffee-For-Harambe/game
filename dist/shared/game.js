...
import { buildGrid } from "./gridutils.js";
export default class Game {
  constructor() {
    ...
    this.teams = [];
    this.teams[0] = new Team([new Character.Rogue(1, 14), new Character.Monk(4, 14), new Character.Ranger(7, 14), new Character.Warrior(10, 14), new Character.Wizard(13, 14)]);
    this.teams[1] = new Team([new Character.Skeleton(2, 1), new Character.Skeleton(3, 1), new Character.Skeleton(8, 2), new Character.Dragon(7, 1), new Character.Skeleton(13, 1), new Character.Skeleton(12, 1)]);
  ...
  update() {
    ...
    if (this.state.gameOver) {
      document.getElementById("lose").style.visibility = this.state.gameOver == 0 ? "visible" : "hidden";
      document.getElementById("win").style.visibility = this.state.gameOver == 1 ? "visible" : "hidden";
    }
...
_defineProperty(Game, "_Instance", null);
